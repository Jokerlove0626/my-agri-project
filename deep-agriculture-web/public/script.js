		...
		anchor.addEventListener("click", function (e) {
			...
			if (targetId && targetId.startsWith("#") && targetId.length > 1) {
				...
				if (targetElement) {
					...
					const headerOffset =
						document.querySelector("header")?.offsetHeight || 64; // Get header height or default
...
function initializeGsapAnimations() {
	...
	tl.fromTo(
		...
		.fromTo(
			"#hero-buttons > a", // Target buttons within the container
